                    ...
                    <div class="row">
                        <div class="col-md-12">
                           ...
                           <table class="table table-striped table-bordered">
                               ...
                               <tr>
                                   <td><a target="_blank"
                                          href="<?php echo e(url('product')); ?>/<?php echo e($name); ?>"><?php $name = (isset($item['name']) ? $item['name'] : null);echo $name; ?></a>
                                   </td>
                               ...
                               <tr>
                                   ...
                                   <td
                                           class="text-right"> <span class="bold totalamout"><p> ৳ <span
                                                       id="total_cost"><?php echo $order->order_total; ?></span>
                                           </p></span> <input
                                               type="hidden"
                                               name="order_total"
                                               id="order_total"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\SXampp\htdocs\suhojbuy.com\resources\views/admin/order/edit.blade.php ENDPATH**/ ?>