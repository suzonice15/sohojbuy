...
<div class="box-body">
    ...
    <input type="hidden" name="status" id="status" value="<?php echo e($order_status); ?>" />
    ...
    $(document).ready(function(){
        ...
        function fetch_data(page,status)
        {
            $.ajax({
                ...
                url:"<?php echo e(url('order/pagination')); ?>?page="+page+"&status="+status,
        ...
        function fetch_data_search(page,query)
        {
            $.ajax({
                type:"GET",
                url:"<?php echo e(url('order/pagination_by_search')); ?>?page="+page+"&query="+query,
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\SXampp\htdocs\suhojbuy.com\resources\views/admin/order/index.blade.php ENDPATH**/ ?>