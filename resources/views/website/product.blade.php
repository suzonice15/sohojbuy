                                        ...
                                        <div id="owl-single-product-thumbnails">
                                            ...
                                            <div class="item">
                                                <img class="img-responsive thum_image_hover " width="85" alt=""
                                                     data-echo="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->feasured_image }}"/>
                                            ...
                                            <div class="item">
                                                <img class="img-responsive thum_image_hover " width="85" alt=""
                                                     data-echo="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_1 }}"/>
                                            ...
                                            <div class="item">
                                                <img class="img-responsive thum_image_hover " width="85" alt=""
                                                     data-echo="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_2 }}"/>
                                            ...
                                            <div class="item">
                                                <img class="img-responsive thum_image_hover " width="85" alt=""
                                                     data-echo="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_3 }}"/>
                                            ...
                                            <div class="item">
                                                <img class="img-responsive thum_image_hover " width="85" alt=""
                                                     data-echo="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_4 }}"/>
                                            ...
                                            <div class="item">
                                                <img class="img-responsive thum_image_hover " width="85" alt=""
                                                     data-echo="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_5 }}"/>
                                            ...
                                            <div class="item">
                                                <img class="img-responsive thum_image_hover " width="85" alt=""
                                                     data-echo="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_6 }}"/>
                                    ...
                                    <div class="stock-container info-container m-t-2"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="stock-box">
                                                    <span class="value"
                                                          style="font-weight: bold;color:green;">{{$product->product_stock}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /.row -->
                                  ...
                                  @money($sell_price)
                                        ...
                                        <div class="quantity-container info-container">
                                            <div class="row">
                                                ...
                                                ?>
                                                <div class="col-sm-8">
                                                    <a data-picture="{{ url('/public/uploads') }}/{{ $product->folder }}/small/{{ $product->feasured_image}}"
